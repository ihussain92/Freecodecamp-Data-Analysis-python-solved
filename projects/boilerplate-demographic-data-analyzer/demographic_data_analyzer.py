...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = higher_education / df[df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])].shape[0] * 100
    lower_education_rich = lower_education / df[~df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])].shape[0] * 100
